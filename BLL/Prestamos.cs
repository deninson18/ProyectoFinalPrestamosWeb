...
namespace BLL
{
    public class Prestamos : ClaseMaestra
    {
        ...
        public override DataTable Listado(string Campos, string Condicion, string Orden)
        {
            ...
            return conexion.ObtenerDatos(("Select PrestamoId,CL.ClienteId,CL.Nombres,R.NombreRuta,FechaInicial,FechaVencimiento,Monto,Cuota,NuSemana,CantidadCuota,Interes,PagoTotal from Prestamos as P inner join Clientes as CL on CL.ClienteId=P.ClienteId inner join Rutas R on R.RutaId=CL.RutaId where " + Condicion + Orden));
