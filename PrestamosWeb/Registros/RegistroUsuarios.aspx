                ...
                <div class="panel-body">                                     
                    ...
                    <div class="form-group col-md-offset-2 ">                          
                        <div class="form-inline">                  
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="idUTextBox" ErrorMessage="ID Incorrecto" Font-Size="Medium" ForeColor="Red" ValidationExpression="[0-9]{1,9}(\.[0-9]{0,2})?$" ValidationGroup="A">*</asp:RegularExpressionValidator>
                        </div>                       
                    </div>
                    <div class="form-group col-md-offset-2 ">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="nombreUTextBox" ErrorMessage="Formato Incorrecto" ForeColor="Red" ValidationExpression="^[a-zA-Z/s]{3,60}$" Font-Size="Medium" ValidationGroup="A">*</asp:RegularExpressionValidator>
                    ...
                    <div class="form-group col-md-offset-2">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="apellidoUTextBox" ErrorMessage="Formato Incorrecto" ValidationExpression="^[a-zA-Z/s]{3,60}$" Font-Size="Medium" ForeColor="Red" ValidationGroup="A">*</asp:RegularExpressionValidator>
                    ...
                    <div class="form-group col-md-offset-2">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="CONFIRME SU CONTRASEÑA" ForeColor="Red" ControlToValidate="confirmarContrasenaTextBox" ValidationGroup="A"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group col-md-offset-2">
