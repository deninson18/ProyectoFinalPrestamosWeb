                ...
                <div class="panel-body">
                    <div class="form-group col-md-offset-1">
                        <div class="form-inline">
                            ...
                            <asp:TextBox ID="idClienteTextBox" runat="server" placeholder="ID" CssClass="form-control" Width="230px" Height="26px"></asp:TextBox>
                    ...
                    <div class="form-group col-md-offset-1">
                        ...
                        <div class="form-inline">
                            <asp:TextBox ID="nombreCliTextBox" runat="server" placeholder="Nombres" CssClass="form-control" Width="400px" Height="26px"></asp:TextBox>
                    ...
                    <div class="form-group col-md-offset-1">
                        ...
                        <div class="form-inline">
                            <asp:TextBox ID="apellidoCliTextBox" runat="server" placeholder="Apellidos" CssClass="form-control" Width="400px" Height="26px"></asp:TextBox>
                            <asp:TextBox ID="cedulaCliTextBox" runat="server" placeholder="Cedula" CssClass="form-control" Width="500px" Height="26px"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group col-md-offset-1">
                        <asp:Label ID="Label4" runat="server" Text="APODO:" Font-Bold="True"></asp:Label>
                        <asp:Label ID="Label5" class="col-md-offset-4" runat="server" Text="DIRECCION:" Font-Bold="True"></asp:Label>
                        <div class="form-inline">
                            <asp:TextBox ID="apodoCliTextBox" runat="server" placeholder="Apodos" CssClass="form-control" Width="400px" Height="26px"></asp:TextBox>
                            <asp:TextBox ID="direccionCliTextBox" runat="server" placeholder="Direccion" CssClass="form-control" Width="500px" Height="26px"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group col-md-offset-1">
                        ...
                        <div class="form-inline">
                            <asp:TextBox ID="referenciaCliTextBox" runat="server" placeholder="Referencia" CssClass="form-control" Width="400px" Height="26px"></asp:TextBox>
                            <asp:TextBox ID="telefonoCliTextBox" runat="server" placeholder="Telefono" CssClass="form-control" Width="500px" Height="26px"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group col-md-offset-1">
                        ...
                        <div class="form-inline">
                            <fieldset>
                                <asp:TextBox ID="celularCliTextBox" runat="server" placeholder="Celular" CssClass="form-control" Width="400px" Height="26px"></asp:TextBox>
