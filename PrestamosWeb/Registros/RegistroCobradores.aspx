                ...
                <div class="panel-body">
                    <div class="form-group col-md-offset-2">
                        <div class="form-inline">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="idCoTextBox" ErrorMessage="Error de Formato" ForeColor="Red" ValidationExpression="^[0-9]*">*</asp:RegularExpressionValidator>
                    ...
                    <div class="form-group col-md-offset-2">
                        ...
                        <asp:TextBox ID="telefonoCoTextBox" runat="server" placeholder="Telefono" CssClass="form-control" Width="800px" Height="26px" MaxLength="14"></asp:TextBox>
                    ...
                    <div class="form-group col-md-offset-2">
                        ...
                        <asp:TextBox ID="celularCoTextBox" runat="server" placeholder="Celular" CssClass="form-control" Width="800px" Height="26px" MaxLength="14"></asp:TextBox>
                    ...
                    <div class="form-group col-md-offset-2">
                        ...
                        <asp:TextBox ID="cedulaCoTextBox" runat="server" placeholder="Cedula" CssClass="form-control" Width="800px" Height="26px" MaxLength="14"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="cedulaCoTextBox" ForeColor="Red" ValidationGroup="A" ErrorMessage="FORMATO INCORRECTO" ValidationExpression="^[0-9]*">*</asp:RegularExpressionValidator>
